...
[Script]
建行数据 = type=http-request,pattern=^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|autoLogin),requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/MaelWeb/Rewrite/refs/heads/main/jhsh_checkIn.js
...
[Script]
http-request ^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|autoLogin) tag=建行数据, script-path=https://raw.githubusercontent.com/MaelWeb/Rewrite/refs/heads/main/jhsh_checkIn.js,requires-body=1
...
[rewrite_local]
^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|autoLogin) url script-request-body https://raw.githubusercontent.com/MaelWeb/Rewrite/refs/heads/main/jhsh_checkIn.js
...
async function main() {
  let opt = {
    url: `https://yunbusiness.ccb.com/clp_coupon/txCtrl?txcode=A3341A168`,
    headers: {
      "Mid": $.info?.MID,
      "Content-Type": "application/json",
